...
<form name="subscribe" action="/cbfeed_subscribe.sandbox.php" method="post" target="dark">
...
<p />
<input type="checkbox" name="agreed"><b>I agree to the above-stated terms.</b><p />
<input type="button" class="man_b" value="Subscribe via PayPal" onclick="checkForm()" />
</form>
<p />
<span style="color:#990000"><b>Important:</b></span> After completing your subscription at PayPal, be sure to<br />click the 'Return To Merchant' button so that your account can be set up.
</div>
