...
<form name="sendorder" action="https://www.sandbox.paypal.com/cgi-bin/webscr" target="_top" method="post">

<img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
<input type="hidden" name="cmd" value="_xclick-subscriptions">
<input type="hidden" name="business" value="paypalsandboxbiz@s1m.com">
