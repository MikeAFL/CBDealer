...
function chkKeys() {
	ajaxCall('chk_keys','/cbsrv/chk_keys.php?keywords='+document.buildAd.keywords.value+'&join='+document.buildAd.join.value);
}
...
<script type=\"text/javascript\" src=\"http://www.cbdealer.com/includes/cbadsrv.html\"></script>
<script type=\"text/javascript\">
today=new Date();";
