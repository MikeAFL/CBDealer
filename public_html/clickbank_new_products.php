...
$query="select count( distinct id) from cb_products where id not in (select id from cb_products_060108)";
require (SRVROOT.'cr/dbconn.php');
$added=mysql_fetch_row($result);
$added=$added[0];

?>

<div>
<h2 style="margin-top:-5px;">New ClickBank Products</h2>
<span style="position:relative; top:-10px;">
<b>ClickBank Marketplace products added since June 1, 2008.</b> (<?=$added?> products added)
<!--br />
...
<?php
$query="select distinct id,title,description from cb_products where subcategory<>'New Products' and id not in (select id from cb_products_060108)";
require (SRVROOT.'cr/dbconn.php');
$movers=array();
