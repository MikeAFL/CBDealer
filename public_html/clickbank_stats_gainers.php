...
<div>
<h2 style="margin-top:-5px;">Big Movers</h2>
<span style="position:relative; top:-10px;">
<b>ClickBank'<!--'-->s Top 20 gainers in Popularity Rank since June 1, 2008.</b>
<br />
...
<?php
$query="select distinct id,category,subcategory,rank_curr,rank_last,rank_diff from stats_poprank where subcategory<>'New Products' and rank_diff is not null order by rank_diff asc limit 20";
