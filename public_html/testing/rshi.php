...
$output= "<span style=\"font-size:9px;font-family:sans-serif\">";
foreach ($ads as $ad) {
	switch ($ad['id']) {
		case "cbdez1aler":
	...
	$output.= "<a style=\"font-size:11px;color:".$ad_data['linkcolor'].";font-family:sans-serif\" href=\"http://$url\" target=\"".$ad_data['target']."\"><b>".$ad['title']."</b></a><br />".$ad['desc']."<p />";
}
$output.= "</span>";
